...
*/
    drawPolygon: function(geometry, style, featureId) {
        ...
        if(geometry.groundOverlayHref) {
            var img = new Image();
            var opacity = style.graphicOpacity || 1;
            ...
            var onLoad = function() {
                ...
                var width = bound.getWidth() / resolution;
                var height = bound.getHeight() / resolution;
                var x = (bound.left / resolution + (-extent.left / resolution));
                var y = ((extent.top / resolution) - bound.top / resolution);
            ...
            img.onload = OpenLayers.Function.bind(onLoad, this);
            img.src = geometry.groundOverlayHref;
            return;
        }
