...
*/
    drawPolygon: function(node, geometry) {
        ...
        if (geometry.groundOverlayHref) {
            ...
            var width = bounds.getWidth() / resolution;
            var height = bounds.getHeight() / resolution;
            var x = (bounds.left / resolution + this.left);
            var y = (this.top - bounds.top / resolution);
            ...
            if (this.inValidRange(x, y)) {
                ...
                node.setAttributeNS(null, "height", height);
                node.setAttributeNS(null, "preserveAspectRatio", "none");
                node.setAttributeNS(this.xlinkns, "href", geometry.groundOverlayHref);
                return node;
             } else {
                return false;
            }
